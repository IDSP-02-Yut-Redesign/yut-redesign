...
class MainboardScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.socket.on("diceRolled", (data) => {
            ...
            // Use this to call moveMarker method
            this.moveMarker(this.playerOneMarker, data.diceNumber);
        });
        // create bg sprite
        this.add
    ...
    onRollButtonClick() {
        ...
        this.rollDice((outputNumber) => {
            ...
            // Emit the "diceRolled" event
            socket.emit("diceRolled", {
                player: "playerOne",
                diceNumber: outputNumber,
            });
        });
    }
